...
var DateUtil = {
  ...
  parseDatetime: function parseDatetime(value) {
    if (typeof value === 'number') {
      return new Date(value);
    }

    var pattern = /^\d{4}-\d{2}-\d{2} \d{2}:\d{2}:\d{2}(:\d{2}Z)?$/;
...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_DateRangePicker_vue_vue_type_style_index_1_id_97458c20_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("b976");
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_DateRangePicker_vue_vue_type_style_index_1_id_97458c20_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_DateRangePicker_vue_vue_type_style_index_1_id_97458c20_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"45449141-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/DateRangePicker.vue?vue&type=template&id=97458c20&scoped=true&
...
// CONCATENATED MODULE: ./src/components/DateRangePicker.vue?vue&type=template&id=97458c20&scoped=true&
...
/* harmony default export */ var DateRangePickervue_type_script_lang_js_ = ({
  ...
  data: function data() {
    ...
    var startDate = util.parseDatetime(this.dateRange.startDate) || null;
    var endDate = util.parseDatetime(this.dateRange.endDate) || null;
  ...
  methods: {
    ...
    clickCancel: function clickCancel() {
      if (this.open) {
        // reset start and end
        var startDate = this.$dateUtil.parseDatetime(this.dateRange.startDate);
        var endDate = this.$dateUtil.parseDatetime(this.dateRange.endDate);
  ...
  computed: {
    ...
    isDirty: function isDirty() {
      var origStart = this.$dateUtil.parseDatetime(this.dateRange.startDate);
      var origEnd = this.$dateUtil.parseDatetime(this.dateRange.endDate);
  ...
  watch: {
    ...
    'dateRange.startDate': function dateRangeStartDate(value) {
      if (!this.$dateUtil.isValidDate(this.$dateUtil.parseDatetime(value))) return;
...
// EXTERNAL MODULE: ./src/components/DateRangePicker.vue?vue&type=style&index=1&id=97458c20&lang=scss&scoped=true&
var DateRangePickervue_type_style_index_1_id_97458c20_lang_scss_scoped_true_ = __webpack_require__("e5b6");
